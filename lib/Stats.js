...
class Stats extends EventEmitter {
  ...
  /*
  Generate new totals
  `includePercentile` flag determines whether or not to calculate a new round of
  percentiles. If `includPercentile` is set to false or undefined, the existing
  calculated percentiles will be preserved.
  */
  _generateStats(buckets, includePercentile) {
    // reduce buckets
    ...
    if (includePercentile) {
      ...
      // pass through previous percentile
